...
import { z } from "zod";
import { wpGet, wpPost, wpPut } from "../client.js";
...
export function register(server: McpServer) {
  ...
  server.tool(
    ...
    async ({ id, widget_type, el_type, fields }) => {
      const params: Record<string, string | number> = {};
  ...
  server.tool(
    ...
    async ({ widget_type, setting, contains, post_type, per_page }) => {
